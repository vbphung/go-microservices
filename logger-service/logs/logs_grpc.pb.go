...
type LogServiceClient interface {
	WriteLog(ctx context.Context, in *LogReq, opts ...grpc.CallOption) (*LogResp, error)
}
...
func (c *logServiceClient) WriteLog(ctx context.Context, in *LogReq, opts ...grpc.CallOption) (*LogResp, error) {
	out := new(LogResp)
...
type LogServiceServer interface {
	WriteLog(context.Context, *LogReq) (*LogResp, error)
...
func (UnimplementedLogServiceServer) WriteLog(context.Context, *LogReq) (*LogResp, error) {
...
func _LogService_WriteLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogServiceServer).WriteLog(ctx, req.(*LogReq))
	}
